...
function PaginationPrevious({
  ...
  return (
    <PaginationLink aria-label="Ir para a página anterior" {...props}>
      <ChevronLeftIcon />
...
function PaginationNext({
  ...
  return (
    <PaginationLink aria-label="Ir para a próxima página" {...props}>
      <ChevronRightIcon />
      <span className="sr-only">Próxima</span>
    </PaginationLink>
  );
}
...
function PaginationFirst({
  ...
  return (
    <PaginationLink aria-label="Ir para a primeira página" {...props}>
      <ChevronFirstIcon />
...
function PaginationLast({
  ...
  return (
    <PaginationLink aria-label="Ir para a última página" {...props}>
      <ChevronLastIcon />
